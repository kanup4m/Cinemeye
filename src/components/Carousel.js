...
const Carousel = () => {
    return (
        <div className="carousel relative shadow-2xl rounded-lg">
            <div className="carousel-inner relative overflow-hidden w-full rounded-lg">
                {/*Slide 1*/}
                <input className="carousel-open" type="radio" id="carousel-1" name="carousel" aria-hidden="true" hidden defaultChecked="checked" />
                <div className="carousel-item absolute opacity-0 rounded-lg" style={{ height: '50vh' }}>
                    <article className="lg:pl-16 sm:pl-2">
                        <div className="flex justify-between text-white">
                            <div className>Action | Adventure | Fantasy | 2018</div>
                            <div>IMDB 9.4 | 7.4</div>
                        </div>
                        <div className="lg:pb-24 sm:pb-0 ">
                            <div className="text-white lg:text-4xl font-extrabold sm:text-sm ">
                                Interstellar
                             </div>
                            <div className="text-white text-bold lg:text-base sm:text-xs">
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellat aliquid distinctio <br /> voluptas beatae in, recusandae eaque, sint nam corporis earum asperiores! Optio  <br /> reiciendis voluptatum culpa ipsam assumenda nesciunt dolorum eligendi.
                             </div>
                            <br />
